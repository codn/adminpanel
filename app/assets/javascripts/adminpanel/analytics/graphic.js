$(document).ready(function() {
    ...
    window.onload = function () {
        ...
        if ($sidebarMenu.height() !== 0) {
            width = width - $sidebarMenu.width() - 80;
        }  else {
            width = width - 40;
        }
        ...
        for (var i = 0, ii = labels.length; i < ii; i++) {
            ...
            (function (x, y, data, lbl, dot) {
                ...
                rect.hover(function () {
                    ...
                    label[0].attr({text: data + " visita" + (data == 1 ? "" : "s")}).show().stop().animateWith(frame, anim, {transform: ["t", lx, ly]}, 200 * is_label_visible);
